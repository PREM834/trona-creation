...
import { History, Heart, Target, Leaf } from 'lucide-react';
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
           Trona creations is a clothing brand 
based in India that was founded in 
2023. The brand is known for its 
high-quality and comfort apparel. 
Trona creations offers a wide 
range of products including , t
shirts, Tops , sweatshirt , jackets, 
trousers, pants, Pyjamas ,cord 
sets, tracksuits, and other.
          </p>
        </motion.div>
